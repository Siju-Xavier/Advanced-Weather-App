...
export const CloudCoverChart = () => {
    ...
    return (
        <ChartContainer config={chartConfig} className="h-[360px] w-full">
            ...
            <XAxis dataKey='hour'tickLine={false} axisLine={false} tickMargin={16}/>
            <YAxis dataKey='clouds' tickLine={false} axisLine={false} tickCount={5} tickMargin={16} tickFormatter={(value) => `${value}°`}/>
