...
export const HumidityChart = () => {
    ...
    return (
        <ChartContainer config={chartConfig} className="h-[360px] w-full">
            ...
            <YAxis dataKey='humidity' tickLine={false} axisLine={false} tickMargin={16}/>
            ...
            <Area dataKey='dew_point' type='natural' fill='var(--color-dew_point)'fillOpacity={0} stroke='var(--color-dew_point)' strokeWidth={2} activeDot={false}/>
