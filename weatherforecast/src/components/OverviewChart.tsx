...
export const OverviewChart = () => {
    ...
    return (
        <ChartContainer config={chartConfig} className="h-[360px] w-full">
            ...
            <YAxis dataKey='temp' tickLine={false} axisLine={false} tickCount={5} tickMargin={16} tickFormatter={(value) => `${value}°`}/>
            ...
            <Area dataKey='feels' type='natural' fillOpacity={0} stroke='var(--color-feels)' strokeWidth={2} activeDot={false}/>
