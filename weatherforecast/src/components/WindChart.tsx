...
export const WindChart = () => {
    ...
    return (
        <ChartContainer config={chartConfig} className="h-[360px] w-full">
            ...
            <XAxis dataKey='hour'tickLine={false} axisLine={false} tickCount={12} tickMargin={16}/>
            <YAxis dataKey='wind_speed' tickLine={false} axisLine={false} tickCount={5} tickMargin={16} />
            ...
            <Area dataKey='wind_gust' type='natural' fill='var(--color-wind_speed)'fillOpacity={0} stroke='var(--color-wind_gust)' strokeWidth={2} activeDot={false}/>
