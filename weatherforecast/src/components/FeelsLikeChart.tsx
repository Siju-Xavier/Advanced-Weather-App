...
export const FeelsLikeChart = () => {
    ...
    return (
        <ChartContainer config={chartConfig} className="h-[360px] w-full">
            ...
            <YAxis dataKey='feels' tickLine={false} axisLine={false} tickCount={5} tickMargin={16} tickFormatter={(value) => `${value}°`}/>
            ...
            <Area dataKey='temp' type='natural' fillOpacity={0} stroke='var(--color-temp)' strokeWidth={2} activeDot={false}/>
